...
public class BooleanComparisonTest extends TestCase {
  private static void doTest(final ExtendedThreadContext tc, final BooleanComparison op, final int lhsTrue[], final int rhsTrue[], final int lhsFalse[], final int rhsFalse[]) {
    ...
    for (int i = 0; i != lhsTrue.length; i++) {
      ...
      assertTrue(op.applyBoolean(NgFloat.valueOf(lhsTrue[i]), floatMetaClass, NgFloat.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgDouble.valueOf(lhsTrue[i]), floatMetaClass, NgFloat.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean((Object)BigInteger.valueOf(lhsTrue[i]), floatMetaClass, (Object)NgFloat.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean((Object)BigDecimal.valueOf(lhsTrue[i]), floatMetaClass, (Object)NgFloat.valueOf(rhsTrue[i])));

      assertTrue(op.applyBoolean(NgByte.valueOf((byte)lhsTrue[i]), doubleMetaClass, NgDouble.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgChar.valueOf((char)lhsTrue[i]), doubleMetaClass, NgDouble.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgShort.valueOf((short)lhsTrue[i]), doubleMetaClass, NgDouble.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgInt.valueOf(lhsTrue[i]), doubleMetaClass, NgDouble.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgLong.valueOf(lhsTrue[i]), doubleMetaClass, NgDouble.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgFloat.valueOf(lhsTrue[i]), doubleMetaClass, NgDouble.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgDouble.valueOf(lhsTrue[i]), doubleMetaClass, NgDouble.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean((Object)BigInteger.valueOf(lhsTrue[i]), doubleMetaClass, (Object)NgDouble.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean((Object)BigDecimal.valueOf(lhsTrue[i]), doubleMetaClass, (Object)NgDouble.valueOf(rhsTrue[i])));

      assertTrue(op.applyBoolean(NgByte.valueOf((byte)lhsTrue[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgChar.valueOf((char)lhsTrue[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgShort.valueOf((short)lhsTrue[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgInt.valueOf(lhsTrue[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgLong.valueOf(lhsTrue[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgFloat.valueOf(lhsTrue[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgDouble.valueOf(lhsTrue[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsTrue[i])));
      ...
      assertTrue(op.applyBoolean(NgByte.valueOf((byte)lhsTrue[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgChar.valueOf((char)lhsTrue[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgShort.valueOf((short)lhsTrue[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgInt.valueOf(lhsTrue[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgLong.valueOf(lhsTrue[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgFloat.valueOf(lhsTrue[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsTrue[i])));
      assertTrue(op.applyBoolean(NgDouble.valueOf(lhsTrue[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsTrue[i])));
    ...
    for (int i = 0; i != lhsFalse.length; i++) {
      ...
      assertFalse(op.applyBoolean(NgFloat.valueOf(lhsFalse[i]), floatMetaClass, NgFloat.valueOf(rhsFalse[i])));
      assertFalse(op.applyBoolean(NgDouble.valueOf(lhsFalse[i]), floatMetaClass, NgFloat.valueOf(rhsFalse[i])));
      assertFalse(op.applyBoolean((Object)BigInteger.valueOf(lhsFalse[i]), floatMetaClass, (Object)NgFloat.valueOf(rhsFalse[i])));
      assertFalse(op.applyBoolean((Object)BigDecimal.valueOf(lhsFalse[i]), floatMetaClass, (Object)NgFloat.valueOf(rhsFalse[i])));

      assertFalse(op.applyBoolean(NgByte.valueOf((byte)lhsFalse[i]), doubleMetaClass, NgDouble.valueOf(rhsFalse[i])));
      assertFalse(op.applyBoolean(NgChar.valueOf((char)lhsFalse[i]), doubleMetaClass, NgDouble.valueOf(rhsFalse[i])));
      assertFalse(op.applyBoolean(NgShort.valueOf((short)lhsFalse[i]), doubleMetaClass, NgDouble.valueOf(rhsFalse[i])));
      assertFalse(op.applyBoolean(NgInt.valueOf(lhsFalse[i]), doubleMetaClass, NgDouble.valueOf(rhsFalse[i])));
      assertFalse(op.applyBoolean(NgLong.valueOf(lhsFalse[i]), doubleMetaClass, NgDouble.valueOf(rhsFalse[i])));
      assertFalse(op.applyBoolean(NgFloat.valueOf(lhsFalse[i]), doubleMetaClass, NgDouble.valueOf(rhsFalse[i])));
