...
public class IntegerComparisonTest extends TestCase {
  private static void doTest(final ExtendedThreadContext tc, final IntegerComparison op, final int lhsEqual[], final int rhsEqual[], final int lhsLessThan[], final int rhsLessThan[], final int lhsGreaterThan[], final int rhsGreaterThan[]) {
    ...
    for (int i = 0; i != lhsEqual.length; i++) {
      ...
      assertTrue(op.intApply(NgFloat.valueOf(lhsEqual[i]), floatMetaClass, NgFloat.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgDouble.valueOf(lhsEqual[i]), floatMetaClass, NgFloat.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsEqual[i]), floatMetaClass, (Object)NgFloat.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsEqual[i]), floatMetaClass, (Object)NgFloat.valueOf(rhsEqual[i])) == 0);

      assertTrue(op.intApply(NgByte.valueOf((byte)lhsEqual[i]), doubleMetaClass, NgDouble.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgChar.valueOf((char)lhsEqual[i]), doubleMetaClass, NgDouble.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgShort.valueOf((short)lhsEqual[i]), doubleMetaClass, NgDouble.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgInt.valueOf(lhsEqual[i]), doubleMetaClass, NgDouble.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgLong.valueOf(lhsEqual[i]), doubleMetaClass, NgDouble.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgFloat.valueOf(lhsEqual[i]), doubleMetaClass, NgDouble.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgDouble.valueOf(lhsEqual[i]), doubleMetaClass, NgDouble.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsEqual[i]), doubleMetaClass, (Object)NgDouble.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsEqual[i]), doubleMetaClass, (Object)NgDouble.valueOf(rhsEqual[i])) == 0);

      assertTrue(op.intApply(NgByte.valueOf((byte)lhsEqual[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgChar.valueOf((char)lhsEqual[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgShort.valueOf((short)lhsEqual[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgInt.valueOf(lhsEqual[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgLong.valueOf(lhsEqual[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgFloat.valueOf(lhsEqual[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgDouble.valueOf(lhsEqual[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply(NgByte.valueOf((byte)lhsEqual[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgChar.valueOf((char)lhsEqual[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgShort.valueOf((short)lhsEqual[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgInt.valueOf(lhsEqual[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgLong.valueOf(lhsEqual[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgFloat.valueOf(lhsEqual[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(NgDouble.valueOf(lhsEqual[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsEqual[i])) == 0);
    ...
    for (int i = 0; i != lhsLessThan.length; i++) {
      ...
      assertTrue(op.intApply(NgFloat.valueOf(lhsLessThan[i]), floatMetaClass, NgFloat.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(NgDouble.valueOf(lhsLessThan[i]), floatMetaClass, NgFloat.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsLessThan[i]), floatMetaClass, (Object)NgFloat.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsLessThan[i]), floatMetaClass, (Object)NgFloat.valueOf(rhsLessThan[i])) == -1);

      assertTrue(op.intApply(NgByte.valueOf((byte)lhsLessThan[i]), doubleMetaClass, NgDouble.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(NgChar.valueOf((char)lhsLessThan[i]), doubleMetaClass, NgDouble.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(NgShort.valueOf((short)lhsLessThan[i]), doubleMetaClass, NgDouble.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(NgInt.valueOf(lhsLessThan[i]), doubleMetaClass, NgDouble.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(NgLong.valueOf(lhsLessThan[i]), doubleMetaClass, NgDouble.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(NgFloat.valueOf(lhsLessThan[i]), doubleMetaClass, NgDouble.valueOf(rhsLessThan[i])) == -1);
