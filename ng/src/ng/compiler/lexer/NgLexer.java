  ...
  public Token nextToken() throws IOException {
    ...
    case 0X1A: // CTRL-Z
      if (this.reader.read() != -1) {
        return new BadCharacterToken(c);
      }
    case -1:
      return new EOFToken();
    ...
    case '*':
      ...
      c1 = this.reader.read();
      if (c1 == '=') {
        return new MultiplyEqualsToken();
      }
      if (c1 == '*') {
        this.reader.mark(1);
        if (this.reader.read() == '=') {
    ...
    case '|':
      ...
      if (c1 == '=') {
        return new ArithmeticOrEqualsToken();
      }
      this.reader.reset();
    ...
    case '&':
      ...
      if (c1 == '=') {
        return new ArithmeticAndEqualsToken();
      }
      this.reader.reset();
    ...
    case '^':
      ...
      c1 = this.reader.read();
      if (c1 == '=') {
        return new ArithmeticXorEqualsToken();
      }
      this.reader.reset();
    ...
    case '+':
      ...
      this.reader.reset();
      if (Character.isDigit(c1) || (c1 == '.' && Character.isDigit(c2))) {
    ...
    case '.':
      this.reader.mark(2);
      c1 = this.reader.read();
      if (c1 == '.' && this.reader.read() == '.') {
        return new EllipsisToken();
      }
      this.reader.reset();
