...
public class DoubleBooleanComparisonWrapper extends BooleanBinaryComparisonWrapper implements DoubleBooleanComparison {
  ...
  public boolean doApplyBoolean(final ThreadContext tc, final double lhs, final char rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgDouble.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final double lhs, final byte rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgDouble.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final double lhs, final short rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgDouble.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final double lhs, final int rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgDouble.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final double lhs, final long rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgDouble.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final double lhs, final float rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgDouble.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final double lhs, final double rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgDouble.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final double lhs, final BigInteger rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgDouble.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final double lhs, final BigDecimal rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgDouble.valueOf(lhs), rhs);
  }
