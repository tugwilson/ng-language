...
public class ShortBooleanComparisonWrapper extends BooleanBinaryComparisonWrapper implements ShortBooleanComparison {
  ...
  public boolean doApplyBoolean(final ThreadContext tc, final short lhs, final char rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgShort.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final short lhs, final byte rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgShort.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final short lhs, final short rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgShort.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final short lhs, final int rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgShort.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final short lhs, final long rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgShort.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final short lhs, final float rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgShort.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final short lhs, final double rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgShort.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final short lhs, final BigInteger rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgShort.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final short lhs, final BigDecimal rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgShort.valueOf(lhs), rhs);
  }
