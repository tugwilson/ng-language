 ...
 *
 */
public class Multiply extends BaseBinaryOperation implements DoubleBinaryArithmeticOperation {
  public Object doApply(final ThreadContext tc, final Object lhs, final Object rhs) {
    return tc.multiply().apply(tc.unwrapToDouble(lhs), rhs);
  }

  public Object doApply(final ThreadContext tc, final Object lhs, final MetaClass rhsMetaClass, final Object rhs) {
    return tc.multiply().apply(tc.unwrapToDouble(lhs), rhsMetaClass, rhs);
  }

  public Object doReverseApply(final ThreadContext tc, final Object lhs, final Object rhs) {
    return tc.multiply().apply(lhs, tc.unwrapToDouble(rhs));
  }
  ...
  public Object doApply(final ThreadContext tc, final double lhs, final BigInteger rhs) {
    return tc.wrap(BigDecimal.valueOf(lhs).multiply(new BigDecimal(rhs.toString())).doubleValue());
  }
  ...
  public double doDoubleApply(final ThreadContext tc, final double lhs, final BigInteger rhs) {
    return BigDecimal.valueOf(lhs).multiply(new BigDecimal(rhs.toString())).doubleValue();
  }
