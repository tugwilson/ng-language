...
public class ConversionNoopImpl implements Conversion {
   ...
   * 
   * @see
   * ng.runtime.metaclass.Conversion#doAsBigDecimal(ng.runtime.threadcontext
   ...
   * 
   * @see
   * ng.runtime.metaclass.Conversion#doAsBigInteger(ng.runtime.threadcontext
   * .ThreadContext, java.lang.Object)
   */
   ...
   * (non-JavaDoc)
   * 
   * @seeng.runtime.metaclass.Conversion#doAsBoolean(ng.runtime.threadcontext.
   * ThreadContext, java.lang.Object)
   */
   ...
   * 
   * @see
   * ng.runtime.metaclass.Conversion#doAsByte(ng.runtime.threadcontext.ThreadContext
   * , java.lang.Object)
   */
   ...
   * 
   * @see
   * ng.runtime.metaclass.Conversion#doAsChar(ng.runtime.threadcontext.ThreadContext
   * , java.lang.Object)
   */
   ...
   * (non-JavaDoc)
   * 
   * @seeng.runtime.metaclass.Conversion#doAsDouble(ng.runtime.threadcontext.
   * ThreadContext, java.lang.Object)
   */
   ...
   * (non-JavaDoc)
   * 
   * @seeng.runtime.metaclass.Conversion#doAsFloat(ng.runtime.threadcontext.
   * ThreadContext, java.lang.Object)
   */
   ...
   * 
   * @see
   * ng.runtime.metaclass.Conversion#doAsInt(ng.runtime.threadcontext.ThreadContext
   * , java.lang.Object)
   */
   ...
   * 
   * @see
   * ng.runtime.metaclass.Conversion#doAsLong(ng.runtime.threadcontext.ThreadContext
   * , java.lang.Object)
   */
   ...
   * (non-JavaDoc)
   * 
   * @seeng.runtime.metaclass.Conversion#doAsShort(ng.runtime.threadcontext.
   * ThreadContext, java.lang.Object)
   */
   ...
   * 
   * @see
   * ng.runtime.metaclass.Conversion#doAsType(ng.runtime.threadcontext.ThreadContext
   ...
   * (non-JavaDoc)
   * 
   * @seeng.runtime.metaclass.Conversion#doAsYourType(ng.runtime.threadcontext.
   * ThreadContext, java.math.BigDecimal)
   */
   ...
   * 
   * @seeng.runtime.metaclass.Conversion#doAsYourType(ng.runtime.threadcontext.
   * ThreadContext, java.math.BigInteger)
   */
