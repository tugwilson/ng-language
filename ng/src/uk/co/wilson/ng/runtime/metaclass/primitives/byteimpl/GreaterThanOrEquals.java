...
public class GreaterThanOrEquals extends BaseBooleanComparison {
  public Object doApply(final ThreadContext tc, final Object lhs, final Object rhs) {
    return tc.greaterThanOrEquals().apply(tc.unwrapToByte(lhs), rhs);
  }

  public Object doApply(final ThreadContext tc, final Object lhs, final MetaClass rhsMetaClass, final Object rhs) {
    return tc.greaterThanOrEquals().apply(tc.unwrapToByte(lhs), rhsMetaClass, rhs);
  }

  public Object doReverseApply(final ThreadContext tc, final Object lhs, final Object rhs) {
    return tc.greaterThanOrEquals().apply(lhs, tc.unwrapToByte(rhs));
  }

  public boolean doApplyBoolean(final ThreadContext tc, final Object lhs, final Object rhs) {
    return tc.greaterThanOrEquals().applyBoolean(tc.unwrapToByte(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final Object lhs, final MetaClass rhsMetaClass, final Object rhs) {
    return tc.greaterThanOrEquals().applyBoolean(tc.unwrapToByte(lhs), rhsMetaClass, rhs);
  }

  public boolean doReverseApplyBoolean(final ThreadContext tc, final Object lhs, final Object rhs) {
    return tc.greaterThanOrEquals().applyBoolean(lhs, tc.unwrapToByte(rhs));
  }
  ...
  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final char rhs) {
    return lhs >= rhs;
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final byte rhs) {
    return lhs >= rhs;
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final short rhs) {
    return lhs >= rhs;
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final int rhs) {
    return lhs >= rhs;
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final long rhs) {
    return lhs >= rhs;
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final float rhs) {
    return lhs >= rhs;
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final double rhs) {
    return lhs >= rhs;
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final BigInteger rhs) {
    return BigInteger.valueOf(lhs).compareTo(rhs) >= 0;
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final BigDecimal rhs) {
