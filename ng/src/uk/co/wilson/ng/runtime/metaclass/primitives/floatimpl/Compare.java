...
public class Compare extends BaseBinaryOperation implements FloatIntegerComparison {
  public Object doApply(final ExtendedThreadContext tc, final Object lhs, final Object rhs) {
    return tc.compare().apply(tc.unwrapToFloat(lhs), rhs);
  }

  public Object doApply(final ExtendedThreadContext tc, final Object lhs, final MetaClass rhsMetaClass, final Object rhs) {
    return tc.compare().apply(tc.unwrapToFloat(lhs), rhsMetaClass, rhs);
  }
  ...
  public int doIntApply(final ExtendedThreadContext tc, final Object lhs, final char rhs) throws NotPerformed {
    return doIntApply(tc, tc.unwrapToFloat(lhs), rhs);
  }
