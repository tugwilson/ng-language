 ...
 *
 */
public class OneFloatParameterSingletonStaticMethodProxy extends OneParameterSingletonStaticMethodProxy {

  /**
   * @param method
   */
  public OneFloatParameterSingletonStaticMethodProxy(final Method method) {
    super(method);
  }
  ...
  public Object doApplyQuick(ThreadContext tc, char p1) {
    return doApplyQuick(tc, (float)p1);
  }
  ...
  public Object doApplyQuick(ThreadContext tc, float p1) {
    if (this.modifiedProxy == null) {
      try {
        return wrapReturnValue(tc, this.method.invoke(null, new Object[]{Float.valueOf(p1)}));
  ...
  public Object doApplyQuick(ThreadContext tc, BigInteger p1) {
    return doApplyQuick(tc, p1.floatValue());
  }
