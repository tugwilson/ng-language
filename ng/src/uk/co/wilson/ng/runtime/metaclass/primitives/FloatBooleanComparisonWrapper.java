...
public class FloatBooleanComparisonWrapper extends BooleanBinaryComparisonWrapper implements FloatBooleanComparison {
  ...
  public boolean doApplyBoolean(final ThreadContext tc, final float lhs, final char rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgFloat.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final float lhs, final byte rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgFloat.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final float lhs, final short rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgFloat.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final float lhs, final int rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgFloat.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final float lhs, final long rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgFloat.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final float lhs, final float rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgFloat.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final float lhs, final double rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgFloat.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final float lhs, final BigInteger rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgFloat.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final float lhs, final BigDecimal rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgFloat.valueOf(lhs), rhs);
  }
