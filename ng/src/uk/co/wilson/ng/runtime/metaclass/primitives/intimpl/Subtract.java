 ...
 *
 */
public class Subtract extends BaseBinaryOperation implements IntBinaryArithmeticOperation {
  public Object doApply(final ThreadContext tc, final Object lhs, final Object rhs) {
    return tc.subtract().apply(tc.unwrapToInt(lhs), rhs);
  }

  public Object doApply(final ThreadContext tc, final Object lhs, final MetaClass rhsMetaClass, final Object rhs) {
    return tc.subtract().apply(tc.unwrapToInt(lhs), rhsMetaClass, rhs);
  }
