...
public class BigDecimalBooleanComparisonWrapper extends BooleanBinaryComparisonWrapper implements BigDecimalBooleanComparison {
  ...
  public boolean doApplyBoolean(final ThreadContext tc, final BigDecimal lhs, final char rhs) throws NotPerformed {
    return doApplyBoolean(tc, (Object)lhs, rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final BigDecimal lhs, final byte rhs) throws NotPerformed {
    return doApplyBoolean(tc, (Object)lhs, rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final BigDecimal lhs, final short rhs) throws NotPerformed {
    return doApplyBoolean(tc, (Object)lhs, rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final BigDecimal lhs, final int rhs) throws NotPerformed {
    return doApplyBoolean(tc, (Object)lhs, rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final BigDecimal lhs, final long rhs) throws NotPerformed {
    return doApplyBoolean(tc, (Object)lhs, rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final BigDecimal lhs, final float rhs) throws NotPerformed {
    return doApplyBoolean(tc, (Object)lhs, rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final BigDecimal lhs, final double rhs) throws NotPerformed {
    return doApplyBoolean(tc, (Object)lhs, rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final BigDecimal lhs, final BigInteger rhs) throws NotPerformed {
    return doApplyBoolean(tc, (Object)lhs, rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final BigDecimal lhs, final BigDecimal rhs) throws NotPerformed {
    return doApplyBoolean(tc, (Object)lhs, rhs);
  }
