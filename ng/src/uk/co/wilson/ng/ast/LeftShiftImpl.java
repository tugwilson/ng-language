 ...
 *
 */
public class LeftShiftImpl extends BinaryOperationImpl {
  ...
  public Object evaluate(final Object instance, final MetaClass metaClass, final ThreadContext tc) {
    return tc.leftShift().apply(this.lhs.evaluate(instance, metaClass, tc), this.rhs.evaluate(instance, metaClass, tc));
  }
}
