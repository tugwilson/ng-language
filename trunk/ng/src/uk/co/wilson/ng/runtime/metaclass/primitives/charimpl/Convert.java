...
class Convert implements CharConversion {
   ...
   * 
   * @see
   * uk.co.wilson.ng.runtime.metaclass.primitives.CharConversion#doAsBoolean
   * (ng.runtime.threadcontext.ThreadContext, char)
   */
   ...
   * 
   * @see
   * uk.co.wilson.ng.runtime.metaclass.primitives.CharConversion#doAsByte(ng
   * .runtime.threadcontext.ThreadContext, char)
   */
   ...
   * 
   * @see
   * uk.co.wilson.ng.runtime.metaclass.primitives.CharConversion#doAsShort(ng
   * .runtime.threadcontext.ThreadContext, char)
   */
   ...
   * 
   * @see
   * uk.co.wilson.ng.runtime.metaclass.primitives.CharConversion#doAsInt(ng.
   * runtime.threadcontext.ThreadContext, char)
   */
   ...
   * 
   * @see
   * uk.co.wilson.ng.runtime.metaclass.primitives.CharConversion#doAsLong(ng
   * .runtime.threadcontext.ThreadContext, char)
   */
   ...
   * 
   * @see
   * uk.co.wilson.ng.runtime.metaclass.primitives.CharConversion#doAsFloat(ng
   * .runtime.threadcontext.ThreadContext, char)
   */
   ...
   * 
   * @see
   * uk.co.wilson.ng.runtime.metaclass.primitives.CharConversion#doAsDouble(
   * ng.runtime.threadcontext.ThreadContext, char)
   */
   ...
   * 
   * @see
   * uk.co.wilson.ng.runtime.metaclass.primitives.CharConversion#doAsBigInteger
   * (ng.runtime.threadcontext.ThreadContext, char)
   */
   ...
   * 
   * @see
   * uk.co.wilson.ng.runtime.metaclass.primitives.CharConversion#doAsBigDecimal
   * (ng.runtime.threadcontext.ThreadContext, char)
   */
   ...
   * 
   * @see
   * uk.co.wilson.ng.runtime.metaclass.primitives.CharConversion#doAsString(
   * ng.runtime.threadcontext.ThreadContext, char)
   */
