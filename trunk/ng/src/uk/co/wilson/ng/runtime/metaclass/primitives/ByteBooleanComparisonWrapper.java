...
public class ByteBooleanComparisonWrapper extends BooleanBinaryComparisonWrapper implements ByteBooleanComparison {
  ...
  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final char rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgByte.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final byte rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgByte.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final short rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgByte.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final int rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgByte.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final long rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgByte.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final float rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgByte.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final double rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgByte.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final BigInteger rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgByte.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final byte lhs, final BigDecimal rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgByte.valueOf(lhs), rhs);
  }
