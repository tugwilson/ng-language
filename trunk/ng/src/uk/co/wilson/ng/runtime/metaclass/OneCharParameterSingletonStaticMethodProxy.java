...
public class OneCharParameterSingletonStaticMethodProxy extends OneParameterSingletonStaticMethodProxy {
   ...
   * @param method
   */
  public OneCharParameterSingletonStaticMethodProxy(Method method) {
    super(method);
  }
  ...
  public Object doApplyQuick(ThreadContext tc, Object p1) {
    return doApplyQuick(tc, tc.convert().asChar(p1));
  }
  ...
  public Object doApplyQuick(ThreadContext tc, byte p1) {
    return doApplyQuick(tc, (char)p1);
  }
  ...
  public Object doApplyQuick(ThreadContext tc, BigInteger p1) {
    return doApplyQuick(tc, (char)p1.intValue());
  }
