 ...
 *
 */
public class OneLongParameterSingletonStaticMethodProxy extends OneParameterSingletonStaticMethodProxy {
  /**
   * @param method
   */
  public OneLongParameterSingletonStaticMethodProxy(Method method) {
    super(method);
  }
  ...
  public Object doApplyQuick(ThreadContext tc, Object p1) {
    return doApplyQuick(tc, tc.convert().asLong(p1));
  }
  ...
  public Object doApplyQuick(ThreadContext tc, char p1) {
    return doApplyQuick(tc, (long)p1);
  }
  ...
  public Object doApplyQuick(ThreadContext tc, long p1) {
    if (this.modifiedProxy == null) {
      try {
        return wrapReturnValue(tc, this.method.invoke(null, new Object[]{Long.valueOf(p1)}));
  ...
  public Object doApplyQuick(ThreadContext tc, BigInteger p1) {
    return doApplyQuick(tc, p1.longValue());
  }
