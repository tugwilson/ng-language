...
public class IntBooleanComparisonWrapper extends BooleanBinaryComparisonWrapper implements IntBooleanComparison {
  ...
  public boolean doApplyBoolean(final ThreadContext tc, final int lhs, final char rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgInt.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final int lhs, final byte rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgInt.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final int lhs, final short rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgInt.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final int lhs, final int rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgInt.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final int lhs, final long rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgInt.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final int lhs, final float rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgInt.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final int lhs, final double rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgInt.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final int lhs, final BigInteger rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgInt.valueOf(lhs), rhs);
  }

  public boolean doApplyBoolean(final ThreadContext tc, final int lhs, final BigDecimal rhs) throws NotPerformed {
    return doApplyBoolean(tc, NgInt.valueOf(lhs), rhs);
  }
