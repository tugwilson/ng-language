...
public class OneShortParameterSingletonStaticMethodProxy extends OneParameterSingletonStaticMethodProxy {
   ...
   * @param method
   */
  public OneShortParameterSingletonStaticMethodProxy(final Method method) {
    super(method);
  }

  @Override
  public Object doStaticCallQuick(final ExtendedThreadContext tc, final Object p1) throws Throwable {
    return doStaticCallQuick(tc, tc.convert().asShort(p1));
  }
  ...
  public Object doStaticCallQuick(final ExtendedThreadContext tc, final short p1) throws Throwable {
    if (this.modifiedCallable == null) {
      try {
        return wrapReturnValue(tc, this.method.invoke(null, tc.prepareParameters(Short.valueOf(p1))));
  ...
  public Object doStaticCallQuick(final ExtendedThreadContext tc, final BigInteger p1) throws Throwable {
    return doStaticCallQuick(tc, p1.shortValue());
  }
