 ...
 *
 */
public class InstanceofImpl extends BinaryOperationImpl {
  ...
  public Object evaluate(Object instance, MetaClass metaClass, ThreadContext tc) {
    return tc.instanceOf().apply(this.lhs.evaluate(instance, metaClass, tc), this.rhs.evaluate(instance, metaClass, tc));
  }
}
