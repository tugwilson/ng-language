 ...
 * 
 */
public class RightShiftImpl extends BinaryOperationImpl {
  ...
  public Object evaluate(final Object instance, final MetaClass metaClass, final ThreadContext tc) {
    return tc.rightShift().apply(this.lhs.evaluate(instance, metaClass, tc), this.rhs.evaluate(instance, metaClass, tc));
  }
}
