...
public class ShiftTest extends TestCase {
  private static void doTest(final ExtendedThreadContext tc, final BinaryShiftOperation op, final int iResult) {
    ...
    try {
      assertTrue(op.longApply(18, (byte) 4) == iResult);
    } catch (final NotPerformed e) {
      assertTrue(false);
    }
    try {
    ...
    try {
      assertTrue(op.longApply(18, (char) 4) == iResult);
    ...
    try {
      assertTrue(op.longApply(18, (short) 4) == iResult);
    } catch (final NotPerformed e) {
    }
    try {
    ...
    try {
      assertTrue(op.longApply(18, 4) == iResult);
    } catch (final NotPerformed e) {
      assertTrue(false);
    }
    try {
    ...
    assertTrue(tc.unwrapToInt(op.apply(tc.wrap(18), (long) 4)) == iResult);
    ...
    assertTrue(tc.unwrapToInt(op.apply(tc.wrap(18), tc.wrap((long) 4))) == iResult);
    ...
    assertTrue(tc.unwrapToInt(op.apply(tc.wrap(18), longMetaClass, tc.wrap((long) 4))) == iResult);
    ...
    assertTrue((tc.unwrapToInt(op.apply(tc.wrap(18), BigInteger.valueOf(4)))) == iResult);
    ...
    assertTrue((tc.unwrapToInt(op.apply(tc.wrap((byte) 18), (Object) BigInteger.valueOf(4)))) == iResult);
    assertTrue((tc.unwrapToInt(op.apply(tc.wrap((char) 18), (Object) BigInteger.valueOf(4)))) == iResult);
    assertTrue((tc.unwrapToInt(op.apply(tc.wrap((short) 18), (Object) BigInteger.valueOf(4)))) == iResult);
    assertTrue((tc.unwrapToInt(op.apply(tc.wrap(18), (Object) BigInteger.valueOf(4)))) == iResult);
    assertTrue((tc.unwrapToLong(op.apply(tc.wrap((long) 18), (Object) BigInteger.valueOf(4)))) == iResult);
    try {
    ...
    assertTrue((tc.unwrapToInt(op.apply(tc.wrap(18), bigIntegerMetaClass, BigInteger.valueOf(4)))) == iResult);
    assertTrue((tc.unwrapToLong(op.apply(tc.wrap((long) 18), bigIntegerMetaClass, BigInteger.valueOf(4)))) == iResult);
    try {
