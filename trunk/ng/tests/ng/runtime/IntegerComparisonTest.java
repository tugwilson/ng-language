...
public class IntegerComparisonTest extends TestCase {
  private static void doTest(final ExtendedThreadContext tc, final IntegerComparison op, final int lhsEqual[], final int rhsEqual[], final int lhsLessThan[], final int rhsLessThan[], final int lhsGreaterThan[], final int rhsGreaterThan[]) {
    ...
    for (int i = 0; i != lhsEqual.length; i++) {
      ...
      assertTrue(tc.unwrapToInt(op.apply((byte)lhsEqual[i], tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((char)lhsEqual[i], tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((short)lhsEqual[i], tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(lhsEqual[i], tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((long)lhsEqual[i], tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((float)lhsEqual[i], tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((double)lhsEqual[i], tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(BigDecimal.valueOf(lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((byte)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((byte)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((byte)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((byte)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsEqual[i]), tc.wrap((byte)rhsEqual[i]))) == 0);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((char)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((char)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((char)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((char)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsEqual[i]), tc.wrap((char)rhsEqual[i]))) == 0);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((short)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((short)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((short)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap((short)rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsEqual[i]), tc.wrap((short)rhsEqual[i]))) == 0);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap((byte)lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap((char)lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap((short)lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), BigInteger.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), BigInteger.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), BigInteger.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), BigInteger.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsEqual[i]), BigInteger.valueOf(rhsEqual[i]))) == 0);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), BigDecimal.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), BigDecimal.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), BigDecimal.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), BigDecimal.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsEqual[i]), BigDecimal.valueOf(rhsEqual[i]))) == 0);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsEqual[i]), tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((Object)BigInteger.valueOf(lhsEqual[i]), (Object)tc.wrap(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((Object)BigDecimal.valueOf(lhsEqual[i]), (Object)tc.wrap(rhsEqual[i]))) == 0);
      ...
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsEqual[i]), (Object)BigInteger.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsEqual[i]), (Object)BigInteger.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsEqual[i]), (Object)BigInteger.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsEqual[i]), (Object)BigInteger.valueOf(rhsEqual[i]))) == 0);
      ...
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsEqual[i]), (Object)BigDecimal.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsEqual[i]), (Object)BigDecimal.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsEqual[i]), (Object)BigDecimal.valueOf(rhsEqual[i]))) == 0);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsEqual[i]), (Object)BigDecimal.valueOf(rhsEqual[i]))) == 0);
      ...
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((byte)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((byte)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((byte)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((byte)rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((char)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((char)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((char)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((char)rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((short)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((short)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((short)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap((short)rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply(tc.wrap((byte)lhsEqual[i]), tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap((char)lhsEqual[i]), tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap((short)lhsEqual[i]), tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsEqual[i]), (Object)tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsEqual[i]), (Object)tc.wrap(rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply((Object)tc.wrap(lhsEqual[i]), (Object)BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)tc.wrap(lhsEqual[i]), (Object)BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)tc.wrap(lhsEqual[i]), (Object)BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)tc.wrap(lhsEqual[i]), (Object)BigInteger.valueOf(rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply((Object)tc.wrap(lhsEqual[i]), (Object)BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)tc.wrap(lhsEqual[i]), (Object)BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)tc.wrap(lhsEqual[i]), (Object)BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)tc.wrap(lhsEqual[i]), (Object)BigDecimal.valueOf(rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), byteMetaClass, tc.wrap((byte)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), byteMetaClass, tc.wrap((byte)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), byteMetaClass, tc.wrap((byte)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), byteMetaClass, tc.wrap((byte)rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), charMetaClass, tc.wrap((char)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), charMetaClass, tc.wrap((char)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), charMetaClass, tc.wrap((char)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), charMetaClass, tc.wrap((char)rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), shortMetaClass, tc.wrap((short)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), shortMetaClass, tc.wrap((short)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), shortMetaClass, tc.wrap((short)rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), shortMetaClass, tc.wrap((short)rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply(tc.wrap((byte)lhsEqual[i]), intMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap((char)lhsEqual[i]), intMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap((short)lhsEqual[i]), intMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), intMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), intMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), intMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), intMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsEqual[i]), intMetaClass, (Object)tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsEqual[i]), intMetaClass, (Object)tc.wrap(rhsEqual[i])) == 0);

      assertTrue(op.intApply(tc.wrap((byte)lhsEqual[i]), longMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap((char)lhsEqual[i]), longMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap((short)lhsEqual[i]), longMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), longMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), longMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), longMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), longMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsEqual[i]), longMetaClass, (Object)tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsEqual[i]), longMetaClass, (Object)tc.wrap(rhsEqual[i])) == 0);

      assertTrue(op.intApply(tc.wrap((byte)lhsEqual[i]), floatMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap((char)lhsEqual[i]), floatMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap((short)lhsEqual[i]), floatMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), floatMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), floatMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), floatMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), floatMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsEqual[i]), floatMetaClass, (Object)tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsEqual[i]), floatMetaClass, (Object)tc.wrap(rhsEqual[i])) == 0);

      assertTrue(op.intApply(tc.wrap((byte)lhsEqual[i]), doubleMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap((char)lhsEqual[i]), doubleMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap((short)lhsEqual[i]), doubleMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), doubleMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), doubleMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), doubleMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), doubleMetaClass, tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsEqual[i]), doubleMetaClass, (Object)tc.wrap(rhsEqual[i])) == 0);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsEqual[i]), doubleMetaClass, (Object)tc.wrap(rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), bigIntegerMetaClass, BigInteger.valueOf(rhsEqual[i])) == 0);
      ...
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsEqual[i])) == 0);
      assertTrue(op.intApply(tc.wrap(lhsEqual[i]), bigDecimalMetaClass, BigDecimal.valueOf(rhsEqual[i])) == 0);
    ...
    for (int i = 0; i != lhsLessThan.length; i++) {
      ...
      assertTrue(tc.unwrapToInt(op.apply((byte)lhsLessThan[i], tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((char)lhsLessThan[i], tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((short)lhsLessThan[i], tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(lhsLessThan[i], tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((long)lhsLessThan[i], tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((float)lhsLessThan[i], tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((double)lhsLessThan[i], tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(BigDecimal.valueOf(lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((byte)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((byte)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((byte)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((byte)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsLessThan[i]), tc.wrap((byte)rhsLessThan[i]))) == -1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((char)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((char)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((char)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((char)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsLessThan[i]), tc.wrap((char)rhsLessThan[i]))) == -1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((short)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((short)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((short)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap((short)rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsLessThan[i]), tc.wrap((short)rhsLessThan[i]))) == -1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap((byte)lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap((char)lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap((short)lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), BigInteger.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), BigInteger.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), BigInteger.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), BigInteger.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsLessThan[i]), BigInteger.valueOf(rhsLessThan[i]))) == -1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), BigDecimal.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), BigDecimal.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), BigDecimal.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), BigDecimal.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsLessThan[i]), BigDecimal.valueOf(rhsLessThan[i]))) == -1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsLessThan[i]), tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((Object)BigInteger.valueOf(lhsLessThan[i]), (Object)tc.wrap(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((Object)BigDecimal.valueOf(lhsLessThan[i]), (Object)tc.wrap(rhsLessThan[i]))) == -1);
      ...
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsLessThan[i]), (Object)BigInteger.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsLessThan[i]), (Object)BigInteger.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsLessThan[i]), (Object)BigInteger.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsLessThan[i]), (Object)BigInteger.valueOf(rhsLessThan[i]))) == -1);
      ...
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsLessThan[i]), (Object)BigDecimal.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsLessThan[i]), (Object)BigDecimal.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsLessThan[i]), (Object)BigDecimal.valueOf(rhsLessThan[i]))) == -1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsLessThan[i]), (Object)BigDecimal.valueOf(rhsLessThan[i]))) == -1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((byte)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((byte)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((byte)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((byte)rhsLessThan[i])) == -1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((char)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((char)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((char)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((char)rhsLessThan[i])) == -1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((short)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((short)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((short)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap((short)rhsLessThan[i])) == -1);
      ...
      assertTrue(op.intApply(tc.wrap((byte)lhsLessThan[i]), tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap((char)lhsLessThan[i]), tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap((short)lhsLessThan[i]), tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsLessThan[i]), (Object)tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsLessThan[i]), (Object)tc.wrap(rhsLessThan[i])) == -1);
      ...
      assertTrue(op.intApply((Object)tc.wrap(lhsLessThan[i]), (Object)BigInteger.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)tc.wrap(lhsLessThan[i]), (Object)BigInteger.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)tc.wrap(lhsLessThan[i]), (Object)BigInteger.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)tc.wrap(lhsLessThan[i]), (Object)BigInteger.valueOf(rhsLessThan[i])) == -1);
      ...
      assertTrue(op.intApply((Object)tc.wrap(lhsLessThan[i]), (Object)BigDecimal.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)tc.wrap(lhsLessThan[i]), (Object)BigDecimal.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)tc.wrap(lhsLessThan[i]), (Object)BigDecimal.valueOf(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)tc.wrap(lhsLessThan[i]), (Object)BigDecimal.valueOf(rhsLessThan[i])) == -1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), byteMetaClass, tc.wrap((byte)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), byteMetaClass, tc.wrap((byte)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), byteMetaClass, tc.wrap((byte)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), byteMetaClass, tc.wrap((byte)rhsLessThan[i])) == -1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), charMetaClass, tc.wrap((char)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), charMetaClass, tc.wrap((char)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), charMetaClass, tc.wrap((char)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), charMetaClass, tc.wrap((char)rhsLessThan[i])) == -1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), shortMetaClass, tc.wrap((short)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), shortMetaClass, tc.wrap((short)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), shortMetaClass, tc.wrap((short)rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), shortMetaClass, tc.wrap((short)rhsLessThan[i])) == -1);
      ...
      assertTrue(op.intApply(tc.wrap((byte)lhsLessThan[i]), intMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap((char)lhsLessThan[i]), intMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap((short)lhsLessThan[i]), intMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), intMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), intMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), intMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), intMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsLessThan[i]), intMetaClass, (Object)tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsLessThan[i]), intMetaClass, (Object)tc.wrap(rhsLessThan[i])) == -1);

      assertTrue(op.intApply(tc.wrap((byte)lhsLessThan[i]), longMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap((char)lhsLessThan[i]), longMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap((short)lhsLessThan[i]), longMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), longMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), longMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), longMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), longMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsLessThan[i]), longMetaClass, (Object)tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsLessThan[i]), longMetaClass, (Object)tc.wrap(rhsLessThan[i])) == -1);

      assertTrue(op.intApply(tc.wrap((byte)lhsLessThan[i]), floatMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap((char)lhsLessThan[i]), floatMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap((short)lhsLessThan[i]), floatMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), floatMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), floatMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), floatMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), floatMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsLessThan[i]), floatMetaClass, (Object)tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsLessThan[i]), floatMetaClass, (Object)tc.wrap(rhsLessThan[i])) == -1);

      assertTrue(op.intApply(tc.wrap((byte)lhsLessThan[i]), doubleMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap((char)lhsLessThan[i]), doubleMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap((short)lhsLessThan[i]), doubleMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), doubleMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), doubleMetaClass, tc.wrap(rhsLessThan[i])) == -1);
      assertTrue(op.intApply(tc.wrap(lhsLessThan[i]), doubleMetaClass, tc.wrap(rhsLessThan[i])) == -1);
    ...
    for (int i = 0; i != lhsGreaterThan.length; i++) {
      ...
      assertTrue(tc.unwrapToInt(op.apply((byte)lhsGreaterThan[i], tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((char)lhsGreaterThan[i], tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((short)lhsGreaterThan[i], tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(lhsGreaterThan[i], tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((long)lhsGreaterThan[i], tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((float)lhsGreaterThan[i], tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((double)lhsGreaterThan[i], tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(BigDecimal.valueOf(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((byte)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((byte)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((byte)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((byte)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsGreaterThan[i]), tc.wrap((byte)rhsGreaterThan[i]))) == 1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((char)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((char)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((char)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((char)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsGreaterThan[i]), tc.wrap((char)rhsGreaterThan[i]))) == 1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((short)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((short)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((short)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap((short)rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsGreaterThan[i]), tc.wrap((short)rhsGreaterThan[i]))) == 1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap((byte)lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap((char)lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap((short)lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), BigInteger.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), BigInteger.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), BigInteger.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), BigInteger.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsGreaterThan[i]), BigInteger.valueOf(rhsGreaterThan[i]))) == 1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), BigDecimal.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), BigDecimal.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), BigDecimal.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), BigDecimal.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(BigInteger.valueOf(lhsGreaterThan[i]), BigDecimal.valueOf(rhsGreaterThan[i]))) == 1);
      ...
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply(tc.wrap(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((Object)BigInteger.valueOf(lhsGreaterThan[i]), (Object)tc.wrap(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((Object)BigDecimal.valueOf(lhsGreaterThan[i]), (Object)tc.wrap(rhsGreaterThan[i]))) == 1);
      ...
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigInteger.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigInteger.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigInteger.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigInteger.valueOf(rhsGreaterThan[i]))) == 1);
      ...
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigDecimal.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigDecimal.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigDecimal.valueOf(rhsGreaterThan[i]))) == 1);
      assertTrue(tc.unwrapToInt(op.apply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigDecimal.valueOf(rhsGreaterThan[i]))) == 1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((byte)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((byte)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((byte)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((byte)rhsGreaterThan[i])) == 1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((char)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((char)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((char)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((char)rhsGreaterThan[i])) == 1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((short)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((short)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((short)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap((short)rhsGreaterThan[i])) == 1);
      ...
      assertTrue(op.intApply(tc.wrap((byte)lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap((char)lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap((short)lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsGreaterThan[i]), (Object)tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsGreaterThan[i]), (Object)tc.wrap(rhsGreaterThan[i])) == 1);
      ...
      assertTrue(op.intApply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigInteger.valueOf(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigInteger.valueOf(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigInteger.valueOf(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigInteger.valueOf(rhsGreaterThan[i])) == 1);
      ...
      assertTrue(op.intApply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigDecimal.valueOf(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigDecimal.valueOf(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigDecimal.valueOf(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)tc.wrap(lhsGreaterThan[i]), (Object)BigDecimal.valueOf(rhsGreaterThan[i])) == 1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), byteMetaClass, tc.wrap((byte)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), byteMetaClass, tc.wrap((byte)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), byteMetaClass, tc.wrap((byte)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), byteMetaClass, tc.wrap((byte)rhsGreaterThan[i])) == 1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), charMetaClass, tc.wrap((char)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), charMetaClass, tc.wrap((char)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), charMetaClass, tc.wrap((char)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), charMetaClass, tc.wrap((char)rhsGreaterThan[i])) == 1);
      ...
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), shortMetaClass, tc.wrap((short)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), shortMetaClass, tc.wrap((short)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), shortMetaClass, tc.wrap((short)rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), shortMetaClass, tc.wrap((short)rhsGreaterThan[i])) == 1);
      ...
      assertTrue(op.intApply(tc.wrap((byte)lhsGreaterThan[i]), intMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap((char)lhsGreaterThan[i]), intMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap((short)lhsGreaterThan[i]), intMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), intMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), intMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), intMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), intMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsGreaterThan[i]), intMetaClass, (Object)tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsGreaterThan[i]), intMetaClass, (Object)tc.wrap(rhsGreaterThan[i])) == 1);

      assertTrue(op.intApply(tc.wrap((byte)lhsGreaterThan[i]), longMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap((char)lhsGreaterThan[i]), longMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap((short)lhsGreaterThan[i]), longMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), longMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), longMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), longMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), longMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)BigInteger.valueOf(lhsGreaterThan[i]), longMetaClass, (Object)tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply((Object)BigDecimal.valueOf(lhsGreaterThan[i]), longMetaClass, (Object)tc.wrap(rhsGreaterThan[i])) == 1);

      assertTrue(op.intApply(tc.wrap((byte)lhsGreaterThan[i]), floatMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap((char)lhsGreaterThan[i]), floatMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap((short)lhsGreaterThan[i]), floatMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), floatMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
      assertTrue(op.intApply(tc.wrap(lhsGreaterThan[i]), floatMetaClass, tc.wrap(rhsGreaterThan[i])) == 1);
